...
class ReflectionNetwork(nn.Module):
    ...
    def forward(self, x):
        ...
        convs2R = convs2R[:,:,:deconv3g.size(2),:deconv3g.size(3)] # crop
        sum3g = torch.cat((deconv3g, convs2R),1)

        deconv2g = self.deconv2_2(self.deconv2_1(sum3g))#64*64
        convs1R = convs1R[:,:,:deconv2g.size(2),:deconv2g.size(3)] # crop
        ...
        convs4R = convs4R[:,:,:deconv03R.size(2),:deconv03R.size(3)] # crop
        deconv5gfE = deconv5gfE[:,:,:deconv03R.size(2),:deconv03R.size(3)] # crop
        ...
        convs3R = convs3R[:,:,:deconv13R.size(2),:deconv13R.size(3)] # crop
        deconv4gfE = deconv4gfE[:,:,:deconv13R.size(2),:deconv13R.size(3)] # crop
        ...
        convs2R = convs2R[:,:,:deconv23R.size(2),:deconv23R.size(3)] # crop
        deconv3gfE = deconv3gfE[:,:,:deconv23R.size(2),:deconv23R.size(3)] # crop
        ...
        convs1R = convs1R[:,:,:deconv33R.size(2),:deconv33R.size(3)] # crop
        deconv2gfE = deconv2gfE[:,:,:deconv33R.size(2),:deconv33R.size(3)] # crop
        ...
        #128*128
        contour = contour[:,:,:deconv43R.size(2),:deconv43R.size(3)] # crop
        ...
        # hardcode outputR to outputB for eval purpose before fixing size problem
        return outputB, outputB, contour
